...
The catalog uses **Observable JS**, which renders in the browser. The whole site builds with **Quarto alone, no R or Python runtime**, keeping both local setup and CI deployment simple.

---

## Making edits locally: quick start
